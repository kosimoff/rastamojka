  ...
  methods: {
    calculate: function calculate() {
      ...
      if (this.sng) {
        ...
        this.poshlina = this.price * this.poshlinaSNGRate / 100 * 1;
      }
      ...
      for (var i = 0; i < this.procedurePrice.length; i++) {
        if (this.price >= this.procedurePrice[i].min && this.price <= this.procedurePrice[i].max) {
          this.procedure = this.procedurePrice[i].cost;
        }
      }
